<div class="container-fluid">
            ...
            <div class="row clearfix">
			 <div class="card">
                        <div class="header">
                            <h2>
                                IMPORT LIBUR SISWA <?php $skr = $_GET['date'] ;  echo $skr;?>
                            </h2>
                        </div>
                        <div class="body">
                            <form name="myForm" id="myForm" onSubmit="return validateForm2()" action="controller/libur_import.php" method="post" enctype="multipart/form-data">
											<div class="row clearfix">
												<div class="col-sm12 col-xs-12">
														<div class="form-group">
															<div class="form-line">
																<input type="file" id="filelibur" name="filelibur"  class="form-control" required>
															</div>
