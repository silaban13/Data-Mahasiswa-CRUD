				...
				<div class="content-top-grids">
					...
					<div class="col-md-4 contact-right">
						<div class="contact-right-top">
							<div class="contact-right-middle-heading wow fadeInUp animated" data-wow-delay=".5s">
								<h3><img src="images/logo.jpg" width="70%" alt="Image"></h3>
							</div>
						...
						<div class="contact-right-middle">
							...
							<div class="login-info">
								...
								<a href="login"><input class="wow fadeInRight animated" data-wow-delay=".5s" type="submit" name="Sign In" value="Login Administrator">
					...
					<div class="col-md-4 content-right">
						<div class="clock-grids wow fadeInRight animated" data-wow-delay=".5s">
							...
							<div class="clock-bottom">
								<div class="clock">
									<marquee scrollamount="5"><b style="color:white" >Terimakasih Atas Kehadirannya </b></marquee>
